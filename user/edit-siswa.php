<script src="../js/jquery.validate.min.js" type="text/javascript"></script>
		...
		function hitNilai()
		{
			...
			jml = parseInt((ind+ing+mat+ipa+ips+ppkn)/4);
...
<style>
#rightPan{width:75%; float:left; background-color:#F6F4E4;}
...
#rightPan h2{ height:36px; color:#8F146E; font-size:16px; padding:0 0 0 85px; margin:0px 0 0 3px;}
</style>
<div id="rightPan">
...
<form method="post" action="" name="frm" id="frm"<table>>

<?php
include('koneksi.php');


$q = mysql_query("select * from tbl_siswa where nama='surya'");
...
<table>
<tr><td width="200">Bahasa Indonesia</td><td>: <input type="text" name="bhs_indo" size="25" maxlength="3" onchange="hitNilai()" value="<?php echo $r['ind']; ?>"></td></tr>
...
<tr><td></td><td><input type="submit" value="Ubah & Simpan" class="button" onclick="tb_remove()"/></td></tr>
<?php
}
?>
</table>
